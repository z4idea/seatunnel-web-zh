...
@RestController
@RequestMapping("/seatunnel/api/v1/http-datasource")
public class HttpDatasourceController {

    @Resource private IHttpDatasourceService httpDatasourceService;

    @PostMapping("/preview")
    public Result<HttpDatasourcePreviewRes> preview(@RequestBody HttpDatasourcePreviewReq req) {
        return Result.success(httpDatasourceService.preview(req));
    }
}
