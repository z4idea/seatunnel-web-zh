...
public class LocalFileDataSourceFactory implements DataSourceFactory {
    ...
    public Set<DataSourcePluginInfo> supportedDataSources() {
        DataSourcePluginInfo localFileDatasourcePluginInfo =
                DataSourcePluginInfo.builder()
                        .name(LocalFileOptionRule.PLUGIN_NAME)
        ...
        return Sets.newHashSet(localFileDatasourcePluginInfo);
    }

    @Override
    public DataSourceChannel createChannel() {
        return new LocalFileDatasourceChannel();
    }
}
