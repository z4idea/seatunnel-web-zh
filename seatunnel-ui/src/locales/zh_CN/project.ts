...
export default {
  ...
  node: {
    ...
    non_resources_tips: '请删除所有未授权或已删除资源',
  ...
  synchronization_definition: {
    ...
    create_synchronization_task: '创建采集任务',
    edit_synchronization_task: '编辑采集任务',
    synchronization_task_name: '采集任务名称',
    task_describe: '任务描述',
    create_user: '创建用户',
    create_time: '创建时间',
    update_user: '更新用户',
    ...
    description: '任务描述',
    engine: '引擎',
    task_name_placeholder: '请输入采集任务名称',
    description_placeholder: '请输入任务说明或备注',
    job_mode: '任务模式',
    job_mode_placeholder: '请选择任务模式，支持批处理和流处理',
    job_name: '任务名称',
    job_retry_times: '任务重试次数',
    job_retry_interval_seconds: '任务重试间隔（秒）',
    jars: '扩展 JAR 包',
    jars_placeholder: '可通过 jars 加载第三方依赖包',
    checkpoint_interval: 'Checkpoint 间隔',
    checkpoint_interval_placeholder:
      '请输入两次连续 Checkpoint 之间的时间间隔，单位为毫秒',
    checkpoint_timeout: 'Checkpoint 超时时间',
    checkpoint_timeout_placeholder:
      '请输入单次 Checkpoint 的超时时间，单位为毫秒',
    ...
    custom_parameters: '自定义参数',
    custom_parameters_placeholder: '请输入引擎运行所需的自定义参数',
    tag_filter: '标签过滤',
    tag_filter_placeholder: '按标签指定任务运行所在的 Worker 节点',
    option_BATCH: '批处理',
    option_STREAMING: '流处理',
    option_STREAM: '流处理',
    option_CLUSTER: '集群模式',
    option_CLIENT: '客户端模式',
    node_name_validate: '节点名称不能为空',
    node_name: '节点名称',
    ...
    incremental_column_description: '请选择源表中可用于推进增量状态的字段',
    incremental_column_placeholder: '请选择增量列',
    ...
    schedule_active_end_placeholder: '请选择结束时间',
    schedule_next_trigger: '下次触发时间',
    ...
    copy_transform: '字段复制',
    field_mapper: '字段映射',
    filter_row_kind: '记录类型过滤',
    json_path: 'JSON 路径解析',
    replace_transform: '字段替换',
    multi_field_split: '多字段拆分',
    ...
    filter_row_kind_description: '用于按记录类型过滤数据，只保留需要的变更行。',
    json_path_description: '用于从 JSON 字段中提取指定路径的数据。',
    replace_description: '用于按规则替换字段中的指定内容。',
    multi_field_split_description: '用于将一个字段按分隔符拆分成多个字段。',
    sql_description: '用于通过 SQL 对数据进行查询、过滤或转换。',
    transform_description: '用于对数据进行 {name} 转换处理。',
    table_sync: '待同步表',
    selected_table: '已选中表',
    original_field: '原字段',
    name_tips: '请输入一个字段名',
    ...
    local_file_format: '文件类型',
    local_file_schema: '文件 Schema',
    local_file_preview: '预览数据',
    local_file_add_field: '新增字段',
    local_file_schema_required: '请先预览或维护文件 Schema',
    http_request_summary: '请求摘要',
    http_summary_url: '接口地址',
    http_summary_method: '请求方法',
    http_summary_headers: '请求头',
    http_summary_params: '查询参数',
    http_summary_content_type: 'Content-Type',
    http_summary_body: '请求体',
    http_table_name_placeholder: '请输入逻辑表名，默认使用数据源实例名',
    http_schema: 'HTTP Schema',
    http_preview: '预览数据',
    http_add_field: '新增字段',
    http_schema_required: '请先预览或维护 HTTP Schema',
    http_preview_grouped_hint:
      '嵌套对象字段会自动展开，并使用下划线字段名参与建表；悬浮表头可查看原始 JSON 路径，悬浮单元格可查看完整内容。',
    http_preview_field_path: '字段路径',
    http_preview_json_object: 'JSON 对象（{count} 个字段）',
    http_preview_json_array: 'JSON 数组（{count} 项）',
    csv_use_header_line: '首行作为表头',
    skip_header_row_number: '跳过前几行',
  ...
  synchronization_instance: {
    ...
    status_pending: '等待中',
    status_scheduled: '已调度',
    status_initializing: '初始化中',
    status_running: '运行中',
    status_executing: '执行中',
    status_failing: '失败处理中',
    status_doing_savepoint: '保存点生成中',
    status_savepoint_done: '保存点已完成',
    status_finished: '已完成',
  ...
  synchronizing_task_instance: '采集任务历史',
  task_instance: '任务实例',
  column: '  列  ',
  all_column: '全部',
