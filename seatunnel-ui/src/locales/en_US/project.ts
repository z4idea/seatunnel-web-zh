...
export default {
  ...
  synchronization_definition: {
    ...
    source: 'Source',
    sink: 'Sink',
    drag_source_hint: 'Drag Source into canvas and double click to configure it',
    drag_sink_hint: 'Drag Sink into canvas and double click to configure it',
    drag_transform_hint: 'Drag {name} into canvas and double click to configure it',
    ...
    field_mapper_description: 'Maps and aligns input fields to the target schema.',
    filter_row_kind_description: 'Filters records by row kind and keeps required changes only.',
    ...
    multi_field_split_description: 'Splits one field into multiple fields by delimiter.',
