...
export default {
  ...
  synchronization_definition: {
    ...
    engine: 'Engine',
    task_name_placeholder: 'Please enter the sync task name',
    description_placeholder: 'Please enter the task description',
    job_mode: 'Job Mode',
    job_mode_placeholder:
      'Please select the job mode. Batch and stream are supported',
    job_name: 'Job Name',
    job_retry_times: 'Job Retry Times',
    job_retry_interval_seconds: 'Job Retry Interval (Seconds)',
    jars: 'JAR Packages',
    jars_placeholder: 'Third-party packages can be loaded via jars',
    checkpoint_interval: 'Checkpoint Interval',
    checkpoint_interval_placeholder:
      'The interval in milliseconds between two consecutive checkpoints.',
    checkpoint_timeout: 'Checkpoint Timeout',
    checkpoint_timeout_placeholder:
      'The timeout in milliseconds for a checkpoint.',
    read_limit_rows_per_second: 'Read Limit Rows Per Second',
    read_limit_rows_per_second_placeholder:
    ...
    read_limit_bytes_per_second_placeholder:
      'The each parallelism bytes limit per second for read data from source.',
    savemode_execute_location: 'Save Mode Execute Location',
    custom_parameters: 'Custom Parameters',
    custom_parameters_placeholder: 'Custom parameters for run engine',
    tag_filter: 'Tag Filter',
    tag_filter_placeholder: 'Define the worker where the job runs by tag',
    option_BATCH: 'Batch',
    option_STREAMING: 'Streaming',
    option_STREAM: 'Stream',
    option_CLUSTER: 'Cluster',
    option_CLIENT: 'Client',
    node_name_validate: 'Node name cannot be empty',
    node_name: 'Node Name',
    ...
    schedule_config: 'Configuration',
    schedule_history: 'Execution History',
    schedule_enabled: 'Enable Schedule',
    schedule_disabled: 'Disabled',
    schedule_cron: 'Cron Expression',
    schedule_cron_placeholder: 'For example: 0 0/30 * * * ?',
    schedule_cron_required: 'Cron expression cannot be empty',
    schedule_cron_tip:
      'Use a standard cron expression. The server restores local registrations after restart.',
    schedule_active_start: 'Active Start Time',
    schedule_active_start_placeholder: 'Please select the start time',
    schedule_active_end: 'Active End Time',
    schedule_active_end_placeholder: 'Please select the end time',
    schedule_next_trigger: 'Next Trigger Time',
    ...
    source_name: 'Datasource Instance',
    source_name_validate: 'Please select a datasource instance',
    ...
    filter_row_kind: 'Filter Row Kind',
    json_path: 'JSON Path',
    replace_transform: 'Replace',
    multi_field_split: 'Multi Field Split',
    ...
    kind: 'Kind',
    kind_insert: 'Insert',
    kind_update_before: 'Update Before',
    kind_update_after: 'Update After',
    kind_delete: 'Delete',
    ...
    field_mapper_description:
      'Maps and aligns input fields to the target schema.',
    filter_row_kind_description:
      'Filters records by row kind and keeps required changes only.',
    json_path_description: 'Extracts values from JSON fields by path.',
    replace_description: 'Replaces matched content in fields based on rules.',
    multi_field_split_description:
      'Splits one field into multiple fields by delimiter.',
    sql_description: 'Uses SQL to query, filter, or transform data.',
    transform_description: 'Applies {name} to process and transform data.',
  ...
  synchronization_instance: {
    ...
    status_doing_savepoint: 'Doing Savepoint',
    status_savepoint_done: 'Savepoint Done',
    ...
    refresh_off: 'Off',
    refresh_1s: '1 second',
    refresh_5s: '5 seconds',
    refresh_10s: '10 seconds',
    refresh_30s: '30 seconds',
    refresh_60s: '60 seconds',
    fetch_logs_error: 'Failed to fetch log nodes',
    fetch_log_content_error: 'Failed to fetch log content',
    write: 'Write',
    read: 'Read',
    line: 'lines',
    confirm: 'Confirm',
